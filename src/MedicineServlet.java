...
public class MedicineServlet extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
		...
		try
		{
			...
			PreparedStatement ps =con.prepareStatement("insert into medicine_details(MEDICINE_NAME,MEDICINE_DETAILS,MEDICINE_PRICE,MEDICINE_QUANTITY,MEDICINE_EXPIRY_DATE,STORE_ID,MEDICINE_TYPE_ID) values(?,?,?,?,?,?,?)");
